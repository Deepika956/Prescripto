...
//              onChange={(e)=>setUserData(prev=>({...prev,address:{...prev.address,
//              line1:e.target.value}}))} value={userData.address.line1}
//              type="text" /><br/>
//              <input className="bg-gray-50" 
//              onChange={(e)=>setUserData(prev=>({...prev,address:{...prev.address,
//              line2:e.target.value}}))} value={userData.address.line2}
//              type="text" />   
//             </p>
...
//     onChange={(e)=>setUserData(prev=>({...prev,gender:
...
//     type="date" onChange={(e)=>setUserData(prev=>({...prev,DoB:
//         e.target.value}))} value={userData.DoB}/>
//     :
...
const Myprofile = () => {
  ...
  // Ensure userData has address defined
  const address = userData.address || { line1: "", line2: "" };

  const handleSave = () => {
    // You may want to make an API call here to save the updated data
    setIsEdit(false);
  };
